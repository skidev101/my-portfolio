...
const CallToAction = () => {
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden w-full min-h-[460px] sm:min-h-[390px] px-20 bg-card text-center mt-1 sm:mt-2 rounded-2xl border border-gray-300 dark:border-gray-500">
