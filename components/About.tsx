...
const About = () => {
  return (
    <section
      id="about"
      className="flex justify-center items-center flex-col min-h-screen w-full max-h-max px-2 py-10 -mt-18 md:mt-0"
    >
      <div className="max-w-4xl">

      <h1 className="text-black/90 dark:text-white/90 text-3xl md:text-5xl font-heading text-center">
        About Me
      </h1>

      <p className="text-sm md:text-[1.1rem] text-gray-600 dark:text-gray-300 mt-3 sm:mt-8">
